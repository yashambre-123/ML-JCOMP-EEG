...
int main(int argc, char** argv)
{
  ...
  // are used interchangably.
    ...
    moveit::planning_interface::PlanningSceneInterface planning_scene_interface; // planning_scene_interface will add the collision object to the planning scene monitor.

    // Collision object
    moveit_msgs::CollisionObject collision_object; // this is an variable of message type CollisionObject. Now we need to fill the message with details about the collision object.
